    ...
    <div class="flex space-x-6 rtl:space-x-reverse">
      <a *ngFor="let social of socialLinks" 
        ...
        <ng-container [ngSwitch]="social.name">
          ...
          <svg  *ngSwitchCase="'Tiktok'" class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
...
export class SocialLinksComponent {
  socialLinks = [
    { name: 'Instagram', url: 'https://www.instagram.com/madhat.adly55/' },
    { name: 'Facebook', url: 'https://www.facebook.com/mody.adly.75' },
    { name: 'Tiktok', url: 'https://www.tiktok.com/@medhatadly5' }
  ];
}